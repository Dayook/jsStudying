...
app.get('/naver/news', (req, res) => {
    const client_id = 'SvLx4Ah9gJcMAkwToelg';
    const client_secret = 'LyCZhBxj1X';
    const api_url = 'https://openapi.naver.com/v1/search/news?query=' + encodeURI('날씨'); //encodeURI(req.query.query);
    const option = { //네이버 API 가이드에 맞게 작성
    };
    const options = {
        url: api_url,
        qs: option,
